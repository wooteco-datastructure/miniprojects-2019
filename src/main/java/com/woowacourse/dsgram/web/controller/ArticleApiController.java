...
public class ArticleApiController {
    ...
    @PostMapping
    public ResponseEntity<ArticleInfo> create(ArticleRequest articleRequest, @UserSession LoggedInUser loggedInUser) {
        ArticleInfo articleInfo = articleService.create(articleRequest, loggedInUser);
